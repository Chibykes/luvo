    ...
    <>
      ...
      <main className="max-w-md mx-auto h-screen flex flex-col p-4 gap-4 bg-neutral-50">
        ...
        <div className='space-y-5'>
          ...
          <div className='bg-black from-purple-600 to-purple-500 text-white p-8 rounded-xl space-y-2'>
          ...
          <div className='flex justify-between gap-4'>
            ...
            <Link href={"/fund-wallet"} className='p-4 text-center rounded-lg text-white text-xs font-bold bg-purple-600 w-full shadow-lg'>Fund Wallet</Link>
            <Link href={"/pay"} className='p-4 text-center rounded-lg text-white text-xs font-bold bg-emerald-400 w-full shadow-lg'>Pay</Link>
          ...
          <div className='grid grid-cols-3 bg-white p-4 rounded-lg border border-neutral-200'>
            ...
            <Link href="/fund-wallet">
              <div className='flex flex-col justify-center items-center p-2 space-y-2 active:bg-neutral-200 rounded-md'>
                <svg className='w-9 h-9' xmlns="http://www.w3.org/2000/svg" width="603" height="545" viewBox="0 0 603 545">
                  <g id="Group_1" data-name="Group 1" transform="translate(-401 -342)">
                    <circle id="Ellipse_1" data-name="Ellipse 1" cx="173.5" cy="173.5" r="173.5" transform="translate(401 540)" fill="#34d399"/>
                    <path id="Path_1" data-name="Path 1" d="M461.2,128H80a16,16,0,0,1,0-32H464a16,16,0,0,0,16-16,48,48,0,0,0-48-48H64A64,64,0,0,0,0,96V416a64,64,0,0,0,64,64H461.2c28.02,0,50.8-21.53,50.8-48V176C512,149.53,489.22,128,461.2,128ZM416,336a32,32,0,1,1,32-32A32,32,0,0,1,416,336Z" transform="translate(492 310)" fill="#9333ea" stroke="#000" stroke-width="0"/>
                  </g>
                </svg>
                <p className='font-bold text-xs text-center text-neutral-400'>Fund Wallet</p>
              </div>
            </Link>
            ...
            <Link href="/pay">
              <div className='flex flex-col justify-center items-center p-2 space-y-2 active:bg-neutral-200 rounded-md'>
                ...
                <p className='font-bold text-xs text-center text-neutral-400'>Pay</p>
              </div>
            </Link>
